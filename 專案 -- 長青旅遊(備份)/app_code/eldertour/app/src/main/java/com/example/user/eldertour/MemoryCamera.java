...
public class MemoryCamera extends AppCompatActivity {
    ...
    private void handleBigCameraPhoto() {
        ...
        if (mCurrentPhotoPath != null) {
            galleryAddPic();
            //setPic();
            Toast.makeText(MemoryCamera.this,"加入相簿成功",Toast.LENGTH_LONG).show();
            mCurrentPhotoPath = null;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.memory_camera);

        mImageView = (ImageView) findViewById(R.id.imageView1);
//        mVideoView = (VideoView) findViewById(R.id.videoView1);
        mImageBitmap = null;
        mVideoUri = null;
        // TODO: 2017-03-19 picBtn值得看一下
