...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView home_page_title_hi_textView;
    private TextView home_page_title_mysuit_textView;
    ...
    private void handleBigCameraPhoto() {
        ...
        if (mCurrentPhotoPath != null) {
            galleryAddPic();
            //setPic();
            Toast.makeText(MainActivity.this,"加入相簿成功",Toast.LENGTH_LONG).show();
            mCurrentPhotoPath = null;
...
/********************************************************************************************************************************************************************/
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home_page_title_hi_textView = (TextView) findViewById(R.id.home_page_title_hi_textView);
        home_page_title_mysuit_textView = (TextView) findViewById(R.id.home_page_title_mysuit_textView);

        SharedPreferences pref = getSharedPreferences("myActivityName", 0); //　SharedPreferences  is  like session
        isFirstIn = pref.getBoolean("isFirstIn", true);

        // change word on textview
        if (isFirstIn) {
            home_page_title_hi_textView.setText("歡迎來到長青旅遊~");
            home_page_title_mysuit_textView.setText("您好，請先登入！");

        } else {
            home_page_title_hi_textView.setText(pref.getString("user_name", "failed") + "，您好~^o^");
            home_page_title_mysuit_textView.setText("您今日有?套行程安排!");
        }
        ...
        home_page_memory_icon_imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (isFirstIn) {
                    ...
                    setBtnListenerOrDisable(home_page_memory_icon_imageButton,mTakePicOnClickListener,MediaStore.ACTION_IMAGE_CAPTURE);
