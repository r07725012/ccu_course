...
rem $HeadURL: http://pc2.ecs.csus.edu/repos/pc2v9/branches/PC2_RELEASE_9_1_x/bin/pc2admin.bat $
...
:end
rem eof pc2admin.bat $Id: pc2admin.bat 1761 2009-02-14 21:02:24Z boudreat $
